...
- 📄 **Published** — Heritability of long-term complications in classic galactosemia. *Journal of Inherited Metabolic Disease*, 2026. [doi:10.1002/jimd.70181](https://doi.org/10.1002/jimd.70181)
- 🏥 **Winship Cancer Institute** — Paper in progress on PDAC immunotherapy trial data
- 🎓 **NIH SIBDS** — Selected for Summer Institute in Biostatistics & Data Science at Columbia Mailman (Summer 2026)
- 🏆 **ASA DataFest @ Emory** — Judges' Choice Award (2026)
- 📊 **SOA Exam P** — Passed · FM in preparation
...
[`autopairtest`](https://github.com/UhanWu/autopairtest) —
an R package for automatic pairwise statistical testing, selecting Welch t-test vs. Wilcoxon
rank-sum and chi-square vs. Fisher's exact based on data properties. Includes roxygen2
documentation, a testthat suite, and a pkgdown site.
:::
:::
---
